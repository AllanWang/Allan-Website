...
function navItems()
{
    ...
    <li><a class="animated" id="nr_notes"
       href="http://allanwang.ca/notes/calc/?scroll_to=commons">Notes</a>
    </li>
...
<nav class="white" role="navigation">
    <div class="nav-wrapper container">
        ...
        <a id="logo-container" href="http://allanwang.ca/" class="brand-logo">
            <!--            original ratio width="91.6" height="99.6"-->
            <svg xmlns="http://www.w3.org/2000/svg" width="51" height="56" viewBox="0 0 68.7 74.7">
                <path fill="<?php echo(isset($theme_color) ? $theme_color : '#333333'); ?>"
