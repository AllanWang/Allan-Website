...
$baseUrl = 'https://allanwang.ca/notes/mcgill/comp361/';
...
function hook($phpServer)
{
    ...
    $page_title = "Comp 361 - $page_number";
    $page_description = "Comp 361 - Fall 2017 - $page_number";
    $page_keywords = ['Comp', 'Computer', 'Computer Science', '361', 'Notes', 'McGill'];
    dynamicNotes();
    phpHeader();
    code_highlight();
}
...
{
    inlineBullets(array("Prof's Email" => "mailto:bpientka@cs.mcgill.ca?Subject=Comp%20361",
