...
$baseUrl = 'https://allanwang.ca/notes/mcgill/comp302/';
...
function hook($phpServer)
{
    ...
    $page_title = "Comp 302 - $page_number";
    $page_description = "Comp 302 - Fall 2017 - $page_number";
    $page_keywords = ['Comp', 'Computer', 'Computer Science', '302', 'Notes', 'McGill'];
    dynamicNotes();
    phpHeader();
    code_highlight();
}
